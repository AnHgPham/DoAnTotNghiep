...
\begin{tikzpicture}[
    ...
    \node[below=0.3cm of mfcc, font=\scriptsize, text=gray] {40 nét, 47 khung};
    \node[below=0.3cm of narrow, font=\scriptsize, text=gray] {10 nét, 47 khung};
...
47 cột (47 ``lát cắt'' thời gian) và 10 hàng (10 đặc trưng). Tổng cộng 470
